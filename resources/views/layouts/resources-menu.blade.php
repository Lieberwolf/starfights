<div class="resources container-fluid">
    <div class="row">
        <div class="col-6 col-md-2 offset-md-1">
            <div class="resources-holder" title="{{number_format(floor($planetaryResources->rate_fe + 10), 0, ',', '.')}}/h">
        ...
        <div class="col-6 col-md-2">
            <div class="resources-holder" title="{{number_format(floor($planetaryResources->rate_lut + 10), 0, ',', '.')}}/h">
        ...
        <div class="col-6 col-md-2">
            <div class="resources-holder" title="{{number_format(floor($planetaryResources->rate_h2o + 10), 0, ',', '.')}}/h">
